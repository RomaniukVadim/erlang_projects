...
%% В чемпионате участвуют несколько команд.
%% Каждая команда представлена кортежем:
%%
%% {team, Name, Players}
%% Где Players -- это список игроков.
%% Игрок представлен кортежем:
%%
%% {player, Name, Age, Rating, Health}
%% В целом структура данных, описывающая чемпионат,
%% выглядит так:
%%
%%Championship = [
%%    {team, "Crazy Bulls",
...
%%]
%%
%% Можно пользоваться примером такой структуры,
%% который возвращается функцией champ:sample_champ/0.
